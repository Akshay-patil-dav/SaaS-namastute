...
export default function EditBlogPost() {
    ...
    useEffect(() => {
        const fetchPost = async () => {
            try {
                const res = await apiClient.get(`${ENV.API_BASE_URL}/blog-posts/${id}`);
                const post = res.data;
                setTitle(post.title || '');
                ...
                setVisibility(post.visibility || 'Visible');
                setImageUrl(post.imageUrl || '');
                setAuthor(post.author || '');
                setBlogCategory(post.blogCategory || 'News');
                setTags(post.tags || '');
                setThemeTemplate(post.themeTemplate || '');
            } catch (err) {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await apiClient.put(`${ENV.API_BASE_URL}/blog-posts/${id}`, payload);
    ...
    if (fetching) {
        return (
            <div className="product-page-container" style={{ background: '#f1f5f9', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                <Loader className="spin" size={32} color="#64748b" />
    ...
    return (
        <div className="product-page-container" style={{ background: '#f1f5f9', minHeight: '100vh', padding: '24px', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '24px' }}>
                ...
                <h2 style={{ margin: 0, fontSize: '20px', fontWeight: '600', color: '#1e293b' }}>Edit blog post</h2>
            </div>
