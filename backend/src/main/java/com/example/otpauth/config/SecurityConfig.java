    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/**", "/oauth2/**", "/login/**", "/api/products/**", "/api/stocks/**", "/api/categories/**", "/api/subcategories/**", "/api/brands/**", "/api/units/**", "/api/warranties/**", "/api/sales/**", "/api/pos-sales/**", "/api/transfers/**", "/api/sales-returns/**", "/api/purchases/**", "/api/purchase-returns/**", "/api/settings/**").permitAll()
