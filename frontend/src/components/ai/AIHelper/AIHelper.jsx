...
const SYSTEM_PROMPT = `You are an intelligent AI assistant integrated into Samrajya Software — a SaaS business management platform.
...
const QUICK_ACTIONS = [
  ...
  { icon: '📖', label: 'Explain Feature', prompt: 'Please explain how this feature works in Samrajya Software: ' },
...
export default function AIHelper() {
  ...
  useEffect(() => {
    ...
    const bizName = companyInfo.name || 'Samrajya Software';
    const welcome = [{
      role: 'assistant',
        ...
        <div className={`ai-panel ${isMaximized ? 'ai-panel--max' : ''}`}>
          ...
          <div className="ai-panel__quick-bar">
            ...
            <button
              ...
              onClick={() => {
                setShowQuickActions(false);
                sendMessage('What can you help me with in Samrajya Software?');
              }}
