...
import '../inventory/import-transfer-modal.css'; // Reusing this CSS as it has the same base layout
import '../../../pages/inventory/CreateProduct.css'; // For the rich text toolbar styles used in Description
