                            ...
                            <>
                                ...
                                <label className="toggle-switch">
                                    <input 
                                        type="checkbox" 
                                        checked={true}
                                        onChange={(e) => { handleChange('googleAuthConnected', 'false'); saveSettings(['googleAuthConnected']); }}
                                    />
                                    <span className="toggle-slider"></span>
                                </label>
                            </>
                            ...
                            <>
                                ...
                                <label className="toggle-switch">
                                    <input 
                                        type="checkbox" 
                                        checked={false}
                                        onChange={(e) => { handleChange('googleAuthConnected', 'true'); saveSettings(['googleAuthConnected']); }}
                                    />
                                    <span className="toggle-slider"></span>
                                </label>
                            </>
