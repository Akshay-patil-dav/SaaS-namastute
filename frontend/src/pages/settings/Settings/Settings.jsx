...
import { Storage, BanIp } from '../../../components/settings/OtherSettings/OtherSettings';
                ...
                {!isSubscriber ? (
                    ...
                    <div className="settings-sidebar">
                        <div className="settings-sidebar-section">
                            <div 
                                className={`settings-sidebar-section-title active`}
                            ...
                            {openSection === 'system' && (
                                <ul className="settings-sidebar-list">
                                    <li className={`settings-sidebar-item ${isActive('profile') ? 'active' : ''}`} onClick={() => navigate('/settings/profile')}>
                                        Profile Settings
                                    </li>
                        ...
                        {/* Upgrade / Billing */}
                        <div className="settings-sidebar-section" style={{ marginTop: '16px', borderTop: '1px solid #f1f5f9', paddingTop: '12px' }}>
                            <div 
                                className={`settings-sidebar-section-title ${isActive('billing') ? 'active' : ''}`}
                    ...
                    /* Subscriber view: Full Settings Sidebar */
                    <div className="settings-sidebar">
                        {/* General Settings */}
                        <div className="settings-sidebar-section">
                            <div 
