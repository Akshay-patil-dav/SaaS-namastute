...
import '../inventory/inventory-pages-custom.css';
import AddSalesReturnModal  from '../../components/modals/sales/AddSalesReturnModal';
import EditSalesReturnModal from '../../components/modals/sales/EditSalesReturnModal';
import ViewSalesModal       from '../../components/modals/sales/ViewSalesModal';
import DeleteConfirmModal   from '../../components/modals/common/DeleteConfirmModal';
import InvoiceModal         from '../../components/modals/sales/InvoiceModal';
...
export default function SalesReturn() {
    ...
    const openDelete  = o => { setActiveReturn(o); setDeleteOpen(true);  };
    const openInvoice = o => { setActiveReturn(o); setInvoiceOpen(true); };
    const closeAll    = () => {
    ...
    const statusClass  = s => s==='Received' ? 'oo-badge-completed' : s==='Cancelled' ? 'oo-badge-cancelled' : 'oo-badge-pending';
    ...
    return (
        <div className="online-orders-container">
            ...
            <div className="ss-main-panel">
                ...
                {!loading && fetchError && (
                    <div className="oo-state-row oo-error">
                        ...
                        <button className="oo-retry-btn" onClick={fetchReturns}>Retry</button>
                    </div>
                )}
            ...
            <AddSalesReturnModal
                ...
                onSuccess={() => { fetchReturns(); resetPage(); }}
            />
            ...
            <DeleteConfirmModal
                ...
                message={`Delete sales return ${activeReturn?.referenceNo} for ${activeReturn?.customerName}? This cannot be undone.`}
                isDeleting={deleting}
            />
